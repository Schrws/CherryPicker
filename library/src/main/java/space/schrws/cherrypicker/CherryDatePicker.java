 ...
 */
public class CherryDatePicker extends FrameLayout {
    ...
    private final CherryDatePickerDelegate mDelegate;
    /**
    ...
    public interface OnDateChangedListener {
         ...
         */
        void onDateChanged(CherryDatePicker view, int year, int monthOfYear, int dayOfMonth);
    }
    public CherryDatePicker(Context context) {
        this(context, null);
    }
    public CherryDatePicker(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.datePickerStyle);
    }
    public CherryDatePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }
    public CherryDatePicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        });
    ...
    private CherryDatePickerDelegate createCalendarUIDelegate(Context context, AttributeSet attrs,
                                                        int defStyleAttr, int defStyleRes) {
        return new CherryDatePickerDelegate(this, context, attrs, defStyleAttr, defStyleRes);
    }
    ...
    abstract static class AbstractDatePickerDelegate implements DatePickerDelegate {
        // The delegator
        protected CherryDatePicker mDelegator;
        // The context
        ...
        public AbstractDatePickerDelegate(CherryDatePicker delegator, Context context) {
