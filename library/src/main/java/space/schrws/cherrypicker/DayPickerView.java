...
public class DayPickerView extends ViewGroup {
    ...
    public DayPickerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr,
        ...
        if (!Utils.parseDate(maxDate, tempDate)) {
        ...
        final long setDateMillis = Utils.constrain(
